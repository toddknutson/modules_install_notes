...
PYTHONUSERBASE=$MODULES_DIR/$MODULE_NAME/$VERSION/build pip install --user --ignore-installed biopython==1.70
...
proc ModulesHelp { } {
        global version
        puts stderr "\tThis module adds biopython executable to your path."
}
