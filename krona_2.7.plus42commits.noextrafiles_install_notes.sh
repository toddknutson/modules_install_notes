...
MODULE_NAME=krona
VERSION=2.7.plus42commits.noextrafiles
...
# I don't like the way that "ktImportTaxonomy" writes out a bunch of extra files
# for each node of the XML tree. Therefore, in this installation, I have commented out the 
# necessary lines of code to make this functionality different.

# I commented out the lines 2424-2461 in this file:
# $MODULES_DIR/$MODULE_NAME/$VERSION/Krona/KronaTools/lib/KronaTools.pm
