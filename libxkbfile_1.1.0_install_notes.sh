...
wget https://www.x.org/archive//individual/lib/libxkbfile-1.1.0.tar.gz
tar xvzf libxkbfile-1.1.0.tar.gz


cd $MODULES_DIR/$MODULE_NAME/$VERSION/libxkbfile-1.1.0
