...
PYTHONUSERBASE=$MODULES_DIR/$MODULE_NAME/$VERSION/build pip install --user --ignore-installed pysam
...
proc ModulesHelp { } {
        global version
        puts stderr "\tThis module adds pysam executable to your path."
}
