...
wget https://mirrors.edge.kernel.org/pub/software/scm/git/git-manpages-2.23.0.tar.gz
# wget https://mirrors.edge.kernel.org/pub/software/scm/git/git-htmldocs-2.23.0.tar.gz




tar xzvf git-2.23.0.tar.gz
tar xzvf git-manpages-2.23.0.tar.gz
# tar xzvf git-htmldocs-2.23.0.tar.gz
...
# system "source /home/lmnp/knut0297/software/modules/git/2.23.0/git-completion.bash"
