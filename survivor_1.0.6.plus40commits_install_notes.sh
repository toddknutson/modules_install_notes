...
#######################################################################
# SUCCESSFUL INSTALL and TESTED - works on 2019-04-23
#######################################################################


# SURVIVOR
# Toolset for SV simulation, comparison and filtering
# https://github.com/fritzsedlazeck/SURVIVOR/releases





MODULE_NAME=survivor
VERSION=1.0.6.plus40commits
...
proc ModulesHelp { } {
        global version
        puts stderr "\tThis module adds SURVIVOR executable to your path."
}


# Update the necessary shell environment variables to make the software work
prepend-path PATH "$MODULES_DIR/$MODULE_NAME/$VERSION/SURVIVOR/Debug"
