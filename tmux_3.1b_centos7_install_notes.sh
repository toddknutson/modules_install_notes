...
export PATH="$MODULES_DIR/libevent/2.1.12_centos7/bin:$PATH"
export LIBRARY_PATH="$MODULES_DIR/libevent/2.1.12_centos7/lib:$LIBRARY_PATH"
export LD_LIBRARY_PATH="$MODULES_DIR/libevent/2.1.12_centos7/lib:$LD_LIBRARY_PATH"
export C_INCLUDE_PATH="$MODULES_DIR/libevent/2.1.12_centos7/include:$C_INCLUDE_PATH"
export CPLUS_INCLUDE_PATH="$MODULES_DIR/libevent/2.1.12_centos7/include:$CPLUS_INCLUDE_PATH"
export PKG_CONFIG_PATH="$MODULES_DIR/libevent/2.1.12_centos7/lib/pkgconfig:$PKG_CONFIG_PATH"



PKG_CONFIG_PATH=$MODULES_DIR/libevent/2.1.12_centos6/lib/pkgconfig ./configure --prefix=$MODULES_DIR/$MODULE_NAME/$VERSION
make
make install
...
echo 'export PATH="$MODULES_DIR/tmux/3.1b_centos7/bin:$PATH"' >> ~/.bashrc
echo 'export LD_LIBRARY_PATH="$MODULES_DIR/libevent/2.1.12_centos7/lib:$LD_LIBRARY_PATH"' >> ~/.bashrc
