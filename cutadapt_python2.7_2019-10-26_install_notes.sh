...
PYTHONUSERBASE=$MODULES_DIR/$MODULE_NAME/$VERSION/build pip install --user --ignore-installed cutadapt==1.8.1
...
proc ModulesHelp { } {
        global version
        puts stderr "\tThis module adds cutadapt executable to your path."
}
