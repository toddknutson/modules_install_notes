...
ln -s $MODULES_DIR/$MODULE_NAME/$VERSION/build/bin/python3.7 python
ln -s $MODULES_DIR/$MODULE_NAME/$VERSION/build/bin/python3.7 python3
ln -s $MODULES_DIR/$MODULE_NAME/$VERSION/build/bin/pip3.7 pip
ln -s $MODULES_DIR/$MODULE_NAME/$VERSION/build/bin/pip3.7 pip3
