...
# Get the source code
wget https://mirror.las.iastate.edu/CRAN/src/base/R-4/R-4.0.0.tar.gz
...
# 
#   Source directory:            .
#   Installation directory:      /home/lmnp/knut0297/software/modules/R/4.0.0_mkl
# 
...
setenv          R_LIBS_USER "$HOME/R/knut0297_software_module/x86_64-pc-linux-gnu-library/4.0_mkl"
