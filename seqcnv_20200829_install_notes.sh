...
# https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-017-1566-3
...
wget http://www.iipl.fudan.edu.cn/SeqCNV/SeqCNV.tar.gz
tar -xvzf SeqCNV.tar.gz
...
prepend-path PATH "$MODULES_DIR/$MODULE_NAME/$VERSION/SeqCNV"
